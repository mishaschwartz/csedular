Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "cseduler_production"
  ...
  config.remote_user_key = 'HTTP_X_FORWARDED_USER'
  config.session_timeout = 600 # seconds
  config.validation_script = File.join Rails.root, 'config', 'dummy_validate.sh'
